...
.. code-block:: console
	...
	Options:
	  --neighbors [4|8]               Specifies the number of neighboring cells to
	                                  use.
	  -m, --method [geometric|laplacian]
	                                  Specifies the curvature calculation method.
...
.. code-block:: console
	...
	Usage: rio slice [OPTIONS] INPUT OUTPUT
	  ...
	  Setting the --keep-data option will return the data values. The default is
	  to return a raster of ones and zeros.
	...
	Options:
	  ...
	  --keep-data           Return the input data. Default is to return ones.
...
.. code-block:: console
	...
	Usage: rio std [OPTIONS] INPUT OUTPUT
	  ...
	  Example:
	  rio stddev elevation.tif stddev.tif
