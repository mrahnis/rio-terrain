...
def std(ctx, input, output, neighborhood, njobs, verbose):
    ...
    with rasterio.Env():
        ...
        with rasterio.open(input) as src:
            ...
            if njobs >= 1:
                ...
                read_windows = terrain.tile_grid(src.width, src.height, blockshape[0], blockshape[1], overlap=neighborhood)
    ...
    t1 = clock()
    click.echo('Finished in : {}'.format(terrain.printtime(t0, t1)))
